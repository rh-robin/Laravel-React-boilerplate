...
export default function Welcome() {
    ...
    return (
        <div className="min-h-screen bg-[#070B14] text-slate-100 flex flex-col justify-between selection:bg-indigo-500 selection:text-white relative overflow-hidden transition-colors duration-200">
            <Head title="System Portal — Control Center" />

            {/* Background glowing gradients */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-b from-indigo-500/15 via-purple-500/10 to-transparent blur-3xl pointer-events-none" />
            <div className="absolute -bottom-40 right-10 w-[500px] h-[500px] bg-blue-600/10 blur-3xl pointer-events-none" />
            ...
            <header className="relative z-10 max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between border-b border-slate-800/60">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <span className="font-extrabold text-base tracking-widest uppercase text-white block">
                            TTECH SUITES
                        </span>
            ...
            <main className="relative z-10 max-w-4xl mx-auto px-6 py-16 sm:py-24 text-center my-auto">
                ...
                <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-tight">
                    ...
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-sky-300 to-teal-200">
                ...
                <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
                    <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md">
                        ...
                        <h4 className="font-bold text-white text-sm">Modular Separation</h4>
                        <p className="mt-1 text-xs text-slate-400 leading-relaxed">
                            Isolated <code className="text-indigo-300">routes/admin.php</code> and controllers in a dedicated admin directory.
                        </p>
                    </div>
                    ...
                    <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md">
                        ...
                        <h4 className="font-bold text-white text-sm">Strict Access Control</h4>
                        <p className="mt-1 text-xs text-slate-400 leading-relaxed">
                    ...
                    <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md">
                        <div className="p-2.5 rounded-xl bg-teal-500/10 text-teal-400 w-fit mb-4">
                            <Cpu className="w-5 h-5" />
                        </div>
                        <h4 className="font-bold text-white text-sm">React Inertia Speed</h4>
                        <p className="mt-1 text-xs text-slate-400 leading-relaxed">
            ...
            {/* Footer */}
            <footer className="relative z-10 max-w-7xl mx-auto w-full px-6 py-6 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
