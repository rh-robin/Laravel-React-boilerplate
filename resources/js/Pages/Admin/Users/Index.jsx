                ...
                <div className="rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800/80 p-4 shadow-sm dark:shadow-xl flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="w-full md:w-auto">
                        <select
                            ...
                            className="w-full md:w-auto px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                        >
                                ...
                                {users.data && users.data.length > 0 ? (
                                                ...
                                                <td className="py-3.5 px-6 text-right">
                                                    {currentTab === 'all' ? (
                                                        <div className="flex items-center justify-end gap-2">
                                                            ...
                                                            {isSelf ? (
                                                                <span className="text-[11px] text-slate-500 font-medium px-2 py-1 bg-slate-100 dark:bg-slate-900 rounded-md">
                                                                    You
                                                                </span>
                                                            ) : (
                                                                <button
                                                        ...
                                                        <div className="flex items-center justify-end gap-2">
                                                            <button
                                                                ...
                                                                className="px-2.5 py-1 rounded-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 border border-emerald-500/20 font-semibold flex items-center gap-1 text-[11px] transition-colors cursor-pointer"
                                                            ...
                                                            <button
                                                                ...
                                                                className="px-2.5 py-1 rounded-lg bg-rose-500/10 text-rose-600 dark:text-rose-400 hover:bg-rose-500/20 border border-rose-500/20 font-semibold flex items-center gap-1 text-[11px] transition-colors cursor-pointer"
                                    ...
                                    <tr>
                                        <td colSpan="8" className="py-16 text-center text-slate-500">
                                            <Users className="w-10 h-10 mx-auto text-slate-400 dark:text-slate-600 mb-2 opacity-60" />
