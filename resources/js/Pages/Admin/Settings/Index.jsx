        ...
        <AdminLayout title="Profile Settings">
            ...
            <div className="space-y-6">
                ...
                <div className="rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800/80 p-6 shadow-sm dark:shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <Link
                        href="/admin"
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700/80 bg-slate-50 dark:bg-slate-900/80 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800/80 p-6 sm:p-8 shadow-sm dark:shadow-xl flex flex-col justify-between">
                        <div>
                            ...
                            <form onSubmit={handleProfileSubmit} id="profile-form" className="mt-6 space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                                    />
                                ...
                                <div>
                                    ...
                                    {profileForm.errors.username && (
                                        <p className="text-xs text-rose-500 mt-1">{profileForm.errors.username}</p>
                                    )}
                                </div>
                        ...
                        <div className="mt-8 pt-4 border-t border-slate-200 dark:border-slate-800/80 flex justify-end">
                            <button
                                type="submit"
                                form="profile-form"
                            ...
                            <form onSubmit={handlePasswordSubmit} id="password-form" className="mt-6 space-y-4">
                                <div>
                                    ...
                                    {passwordForm.errors.current_password && (
                                        <p className="text-xs text-rose-500 mt-1">{passwordForm.errors.current_password}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {passwordForm.errors.password && (
                                        <p className="text-xs text-rose-500 mt-1">{passwordForm.errors.password}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {passwordForm.errors.password_confirmation && (
                                        <p className="text-xs text-rose-500 mt-1">{passwordForm.errors.password_confirmation}</p>
                                    )}
                                </div>
                            </form>
                        </div>
